(function() {
    // 'use strict'; TODO enable strict mode and correct your code

    let navBar = document.querySelector("div.nav-bar");
    let deleteButton = document.querySelector(".delete-btn"); // TODO Review
    ...
    function onloadFn() {
        ...
        function getColours() {
            ...
            fetch("https://reqres.in/api/products/")
                ...
                .then((res) => {
                    ...
                    colours = res.data; // TODO
                    colours.reverse(); // TODO Use sort
                    ...
                    colours.forEach((color) => { // TODO use map
        ...
        function deleteUser(selectedRow, userID, deleteButton) {
            ...
            (function confirmFn() {
                ...
                deleteButton.setAttribute("disabled", "disabled"); // TODO
            })();
        }
